...
const caseFiles = [
  ...
  },
  {
    ...
    evidence: [
      ["11·04·2713", "共享密码", "打开1104工程与人事联合复核"],
...
const passwords = [
  ["1104内部记录", "11042713", "周明川手机便笺中的11·04·2713，去掉分隔符。"],
  ["周明川账号", "1104-42-17", "房号1104 + 墙体缺失42厘米 + 人事状态修改17次。"],
  ["1404住户索引", "T040713", "终端指纹T-04-CJ-0713删除身份字母与连接符后派生。"],
  ["1404回访冷备份", "32213", "“首次接触”223倒读为322，再追加岗位短号13。"],
  ["1404特殊保管物", "ZCLH1404", "资产分类ZC-LH去除标点，再拼接原址房号1404。"],
  ["CJ-0713事故协查", "11050713", "殡仪馆凭证日期数字1105 + 当前员工账号数字0713。"],
] as const;
